  ...
  const setAllComponents = () =>
  {
    const  col = [
        ...
        },                       
        {
          ...
          width: 100,
          multiple: 1,
          render: (text, record, index) => <ExpenseButton handlePrint={handlePrint} handleAdd={handleAdd} setMode={setMode} text={`${text}`} />,
        }
      ];
      setColumns(col);
  }
  ...
  return (
    <div className="flex flex-col shadow-md p-2 bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-red-600 via-red-50 to-red-600">
      <div className='flex items-center justify-between'>
        ...
        <span className="btn-label"><PlusCircleOutlined /></span> Add Expense</button>
        </div>
            <div className="pt-2">
              <Table                
                rowKey='id' 
